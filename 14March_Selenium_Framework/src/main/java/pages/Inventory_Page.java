...
public class Inventory_Page extends TestBase
{
	...
	@FindBy(xpath="//a[@class='shopping_cart_link']") private static WebElement cartIcon;
	...
	@FindBy(xpath = "//div[text()='Sauce Labs Backpack']")private WebElement bagPackTitle;
	...
	public String verifybagTitle()
	{
		return bagPackTitle.getText();
